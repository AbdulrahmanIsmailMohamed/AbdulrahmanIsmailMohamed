...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,c,cs,cpp,py,androidstudio,bootstrap,git,github,idea,ktor,linux,mongodb,mysql,expressjs,nodejs,ts,pug,stackoverflow,visualstudio,vscode)](https://skillicons.dev)
<br/>
