...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,cpp,typescript,nestjs,androidstudio,bootstrap,git,github,idea,ktor,linux,mongodb,mysql,postgresql,expressjs,nodejs,pug,stackoverflow,visualstudio,vscode)](https://skillicons.dev)
<br/>
