...
<p>Hi Devs <br>
My name is Abdulrahman, a 25-year-old self-taught programmer passionate about backend development. I started my programming journey two years ago by learning the basics of C++, and since then, I have expanded my skills to include other languages and frameworks.
...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,react,cpp,typescript,nestjs,docker,androidstudio,bootstrap,git,github,idea,ktor,linux,mongodb,mysql,postgresql,expressjs,nodejs,pug,stackoverflow,visualstudio,vscode)](https://skillicons.dev)
<br/>
